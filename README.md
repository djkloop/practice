...
## 🌈 项目
  ...
  - [传统网站 client](./packages/client/README.md)
  - [管理网站 manage](./packages/manage/README.md)
  - [移动网站 mobile](./packages/mobile/README.md)
  - [微信小程序 weapp](./packages/weapp/README.md)
  - [原生应用 native](./packages/native/README.md)
  - [桌面应用 desktop](./pacages/desktop/README.md)
